...
export const articles: Article[] = [
  ...
  // ── Work ──────────────────────────────────────────────────────────────────
  {
    ...
    description: 'GHL bidirectional sync shipped, approval queue live, AI drafts in production. What shipped, what to fix, full feature roadmap, GH Group go-live plan, new team onboarding wizard spec.',
