...
const STOPS = [
  ...
  },
  {
    ...
    who: 'Core family',
    details: 'Scotland home base near Edinburgh — 10 nights. Settle in on arrival, explore Edinburgh and the coast, get the family into a rhythm. Paige departs for Athens from Edinburgh airport July 7. Kyle solo with kids July 7–9. Paige returns July 10 — then the whole family drives to the Highlands.',
    highlights: ['Edinburgh (25 min)', 'Dirleton & Tantallon castles', 'East Lothian beaches', 'Kyle work days', 'Scottish culture soak'],
    action: 'Negotiate and confirm HX booking (10 nights, Jun 30–Jul 10).',
    accommodation: 'HomeExchange (pursuing — 10 nights)',
  ...
  },
  {
    ...
    who: 'Core family',
    details: "Drive from East Lothian on Jul 11 (5–6 hrs). Leave early, stop for lunch en route. Paige has an Airbnb saved — check availability. The most dramatic landscape in Scotland. After 2 nights, continue south-east to Eagle Bray.",
...
const DAYS: TripDay[] = [
  ...
  { date: 'Jul 10', label: 'Paige returns from Athens 🎉 — pack for Highlands', stopId: 'east-lothian', type: 'chill', note: 'Paige returns! Check out of East Lothian.' },
  { date: 'Jul 11', label: 'Drive to Isle of Skye (5–6 hrs)', stopId: 'skye', type: 'transit', note: 'Lunch stop en route' },
  ...
  { date: 'Jul 15', label: 'Drive south → transit toward Dublin', stopId: 'dublin', type: 'transit', note: 'Return Scotland car. Fly or ferry to Dublin.' },
...
const OPEN_ITEMS = [
  ...
  { urgent: true,  text: "Isle of Skye — check Paige's saved Airbnb Jul 11–12 + book backup (peak season)" },
  { urgent: true,  text: 'Eagle Bray Cabins — check Jul 13–14 availability (eaglebray.co.uk)' },
        ...
        {view === 'calendar' && (
          <div className="space-y-1.5">
            <div className="bg-green-50 border border-green-200 rounded-xl p-3 text-sm text-green-800 flex items-start gap-2">
              ...
              <span><strong>Scotland routing confirmed:</strong> East Lothian Jun 30–Jul 10 → Highlands Jul 11–14 → Dublin Jul 16. Ireland dates fixed from Jul 20.</span>
            </div>
