...
const STOPS = [
  ...
  },
  {
    ...
    details: "Transition stop between Scotland and Johnsfort. Richard from Johnsfort advises: don't spend too long here with young kids, but a weekend works well. No car needed — great public transport, Hop-On-Hop-Off buses. Paige's parents fly in separately and join here. Johnsfort collects everyone Monday morning Jul 20.",
    highlights: ['Trinity College & Book of Kells', 'Phoenix Park', 'Hop-On-Hop-Off', 'Temple Bar', 'Family-friendly pubs with food'],
    action: 'Book central family hotel, 3 nights Jul 17–19. No car needed. Coordinate parents\' arrival.',
    accommodation: 'Hotel — open (central Dublin, family-friendly)',
...
const DAYS: TripDay[] = [
  ...
  { date: 'Jul 10', label: 'Paige returns from Athens 🎉', stopId: 'east-lothian', type: 'chill', note: 'Paige returns!' },
  { date: 'Jul 11', label: 'Reset / recovery day', stopId: 'east-lothian', type: 'chill' },
  { date: 'Jul 12', label: 'Drive to Isle of Skye (5–6 hrs)', stopId: 'skye', type: 'transit', note: 'Lunch stop en route' },
  { date: 'Jul 13', label: 'Isle of Skye — Fairy Pools, Storr', stopId: 'skye', type: 'excursion' },
  { date: 'Jul 14', label: 'Skye → Eagle Bray Cabins', stopId: 'eagle-bray', type: 'transit' },
  { date: 'Jul 15', label: 'Eagle Bray — chill, forest, hot tub', stopId: 'eagle-bray', type: 'chill' },
  { date: 'Jul 16', label: 'Drive south toward Edinburgh', stopId: 'east-lothian', type: 'transit' },
  { date: 'Jul 17', label: 'East Lothian — repack, laundry', stopId: 'east-lothian', type: 'chill' },
  { date: 'Jul 18', label: 'Drive/fly to Dublin', stopId: 'dublin', type: 'transit', note: 'Return Scotland car. Parents fly in.' },
  { date: 'Jul 19', label: 'Dublin — city explore, Hop-On-Hop-Off', stopId: 'dublin', type: 'explore' },
...
const OPEN_ITEMS = [
  ...
  { urgent: true,  text: 'Eagle Bray Cabins — check Jul 14–16 availability (eaglebray.co.uk)' },
  { urgent: true,  text: 'Dublin hotel — 3 nights Jul 17–19, central, family-friendly, no car needed' },
