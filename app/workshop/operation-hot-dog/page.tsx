    ...
    <div className="space-y-16 pb-20">
      ...
      <div className="border-b border-midnight/10 pb-8">
        ...
        <div className="flex flex-wrap gap-3 mt-5">
          ...
          <Link href="/workshop/operation-hot-dog/planner" className="inline-flex items-center gap-2 px-4 py-2 bg-amber-500 text-ink rounded-lg text-sm font-bold hover:bg-amber-400 transition-colors">
            <MapPin className="w-4 h-4" /> 🧭 Planner
          </Link>
        </div>
      </div>
