  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f8f7f4]">
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-sm text-center">
        <h2 className="font-display text-2xl text-[#0a0a0a] mb-2">Event Splitter</h2>
        <p className="text-[#0a0a0a]/50 text-sm mb-6">Enter password to view</p>
        <form onSubmit={(e) => {
          e.preventDefault()
          if (input === 'WWW') setUnlocked(true)
        }}>
          <input
            type="password"
            value={input}
            ...
            autoFocus
            className="w-full bg-[#f8f7f4] border border-[#0a0a0a]/10 rounded-lg px-4 py-3 text-center text-lg text-[#0a0a0a] placeholder:text-[#0a0a0a]/30 focus:outline-none focus:border-[#0066FF] focus:ring-1 focus:ring-[#0066FF] mb-4"
          />
          <button
            type="submit"
            className="w-full px-6 py-3 bg-[#0a0a0a] text-[#f8f7f4] rounded-lg font-medium hover:bg-[#0066FF] transition-colors"
          >
            Enter
          </button>
        </form>
